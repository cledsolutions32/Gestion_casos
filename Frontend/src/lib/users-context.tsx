...
type UsersContextValue = {
  ...
  clearError: () => void;
  createUser: (payload: CreateUserPayload) => Promise<{ success: boolean; error?: string }>;
...
export function UsersProvider({ children }: { children: ReactNode }) {
  ...
  const value = useMemo<UsersContextValue>(
    ...
    [users, isLoading, error, refreshUsers, clearError, createUser, updateUser, deleteUser]
  );
